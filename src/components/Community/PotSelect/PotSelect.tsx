...
// interface PotSelectProps {
//   options: { id: number; name: string }[]; // Update options to include potId and potName
//   selected: string;
//   onSelect: (value: string) => void;
// }
...
//             {option.name} {/* Display the pot name */}
//           </option>
//         ))}
//       </S.Select>
//     </S.PotSelect>
...
// interface PotSelectProps {
//   options: { id: number; name: string }[]; // options에 id와 name을 포함한 구조
