...
//     // `RRule` 설정 시 시간 부분을 명확히 지정합니다
//     const rule = new RRule({
//       freq: RRule.MONTHLY,
//       dtstart: moment(startOfMonth).startOf('day').toDate(), // 날짜의 시작 시점을 00:00로 설정
//       bymonthday: dayOfMonth, // 매월 해당 일자로 이벤트 생성
//       interval: 1,
//       until: moment(endOfMonth).endOf('day').toDate(), // 날짜의 끝 시점을 23:59:59로 설정
//     });
